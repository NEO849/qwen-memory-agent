...
## Day-1-Risiken
1. Alibaba ID-Verify (✅ inzwischen erledigt). 2. Modell-Verfügbarkeit dashscope-intl (qwen-plus/max + text-embedding-v3) → Tag 1 smoke-testen. 3. Reuse schmaler als Pitch (markmem hat 0 qwen-Refs → Qwen-Wiring ist net-new).
