...
2. **60% of the score = Innovation + Technical Depth** → we *say out loud*: Qwen in 5 roles across 3 APIs, MCP, "custom algorithm", "stateless / scales out", "error handling", 54 tests.
...
- **Technical Depth 30%** → [2:12] hybrid retrieval · stateless/scales out · atomic/no-race · fail-open error handling · 54 tests + red-team.
